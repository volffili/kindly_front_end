...
const Map = withScriptjs(withGoogleMap((props) => {
    ...
    >
        {
            props.helpRequests.map(request => <CustomMarker helpRequest = {request}/>)
        }
...
const CustomMarker = (props) => {
    ...
    return (
        <Marker
            position={{lat: parseFloat(props.helpRequest.requester_address_lat), lng: parseFloat(props.helpRequest.requester_address_lng)}}
